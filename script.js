document.addEventListener('DOMContentLoaded', () => {
    ...
    (function setupApkDownloadUX(){
        ...
        if(isMobile){
            ...
            if(mobileInstruction) mobileInstruction.textContent = 'Tap the button to download. After download open the APK to install (allow unknown sources if prompted).';
        } else {
            ...
            if(mobileInstruction) mobileInstruction.textContent = 'Scan the QR or use the download link to save the APK to your PC.';
        }
    })();
